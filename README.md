...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/mute-bush-2eea)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/mute-bush-2eea
```

A live public deployment of this template is available at [https://mute-bush-2eea.templates.workers.dev](https://mute-bush-2eea.templates.workers.dev)
